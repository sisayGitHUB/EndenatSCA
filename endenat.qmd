...
```{r}
value_box(
  title = tags$span("Annual Growth Rate", style = "font-size: 22px; font-weight: bold;"),
  value = tags$span(" 15% per year", style = "font-size: 30px;"),
...
```{r}
value_box(
  title = tags$span("Short Term Goal", style = "font-size: 20px; font-weight: bold;"), # Title font size
  value = tags$span("1,500 Members", style = "font-size: 25px;"), # Reduced value font size
...
```{r}
value_box(
  title = tags$span("Medium Term Goal ", style = "font-size: 20px; font-weight: bold;"),
  value = tags$span("$100000 Capital", style = "font-size: 25px;"),
...
```{r}
value_box(
  title = tags$span("Long Term Goal", style = "font-size: 20px; font-weight: bold;"),
  value = tags$span("Competetive Bank", style = "font-size: 25px;"), 
